    ...
    if (resultType === "liquidComposition") {
        tableRows = props.calculation.result.map((result: IResult) => {
            return {
                value: result.id,
                display: [
                    result.xmethane.value.toFixed(liquidHeaders[0].fixed),
                    result.xethane.value.toFixed(liquidHeaders[0].fixed),
                    result.xpropane.value.toFixed(liquidHeaders[0].fixed),
                    result.xic4.value.toFixed(liquidHeaders[0].fixed),
                    result.xnc4.value.toFixed(liquidHeaders[0].fixed),
                    result.xic5.value.toFixed(liquidHeaders[0].fixed),
                    result.xnc5.value.toFixed(liquidHeaders[0].fixed),
                    result.xnc6.value.toFixed(liquidHeaders[0].fixed),
                    result.xnitrogen.value.toFixed(liquidHeaders[0].fixed),
                ]
            }
        })
        ...
        tableRows = props.calculation.result.map((result: IResult) => {
            return {
                value: result.id,
                display: [
                    result.ymethane.value.toFixed(gasHeaders[0].fixed),
                    result.yethane.value.toFixed(gasHeaders[0].fixed),
                    result.ypropane.value.toFixed(gasHeaders[0].fixed),
                    result.yic4.value.toFixed(gasHeaders[0].fixed),
                    result.ync4.value.toFixed(gasHeaders[0].fixed),
                    result.yic5.value.toFixed(gasHeaders[0].fixed),
                    result.ync5.value.toFixed(gasHeaders[0].fixed),
                    result.ync6.value.toFixed(gasHeaders[0].fixed),
                    result.ynitrogen.value.toFixed(gasHeaders[0].fixed),
                ]
            }
        })
        headers = gasHeaders;
